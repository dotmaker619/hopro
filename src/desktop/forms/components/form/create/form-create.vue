<template>
  <div class="form-builder--create">
    <form-create-empty v-if="sections.length===0"></form-create-empty>
    <div v-else class="form-builder--create__content">
...
<script>
  import formCreateEmpty from "./components/form-create-empty";
  ...
  export default {
    components: { formCreateEmpty, formTitle, formSection, formFields, fieldValues },
    data() {
      return {
        isEmpty: true,
      };
